...
def train_and_evaluate_model() -> None:
    ...
    try:
        ...
        for i, var in enumerate(X.columns):
            ...
            # Get p-value from statsmodels (skip const)
        ...
        # Display coefficient table with p-values
        st.subheader("📈 Variable Importance with P-Values")
        display_df = coef_df[["Variable", "Coefficient", "P_Value", "Significance", "Type"]].copy()
        ...
        # Significance legend
        st.write("**Significance codes:** *** p≤0.001, ** p≤0.01, * p≤0.05, . p≤0.10")
